...
function adresKartiOlustur(obje) {
	...
	const koordinatlar = document.createElement("p");
	...
	cardInfoDiv.appendChild(ipAdress);
	cardInfoDiv.appendChild(ulke);
	cardInfoDiv.appendChild(koordinatlar);
	...
	ipAdress.textContent = obje.sorgu;
	ulke.textContent = `${obje.ülke} (${obje.ülkeKodu})`;
	koordinatlar.textContent = `Ènlem:${obje.enlem} Boylam:${obje.boylam}`;
